...
@section('content')
		...
		<div class="container">
			...
			<div class="post-icons-area">
				<ul class="post-icons">
					...
					<li>
                 @guest
                 <a href="javascript:void(0);" onclick="toastr.info('To ADD Favourite list. You Need to Login First.','Info',{closeButton:true,progressBar:true,})">
	...
	<section class="recomended-area section">
		<div class="container">
          ...
          <a href="javascript:void(0);" onclick="document.getElementById('favourite-form-{{$randompost->id}}').submit();" class="{{!Auth::user()->favourite_posts->where('pivot.post_id',$randompost->id)->count() == 0 ? 'favourite_posts' : ''}}">
			...
			<div class="row">
				...
				<div class="col-lg-8 col-md-12">
					<div class="comment-form">
						...
						@guest
						<p>
							For Post A New Comment. You Ned to Login First. <a href="{{route('login')}}">Login</a>
						</p>
...
@push('js')
	...
	<script src="{{ asset('assets/frontend/css/single-post/common-js/jquery-3.1.1.min.js') }}"></script>

	<script src="{{ asset('assets/frontend/css/single-post/common-js/tether.min.js') }}"></script>

	<script src="{{ asset('assets/frontend/css/single-post/common-js/bootstrap.js') }}"></script>

	<script src="{{ asset('assets/frontend/css/single-post/common-js/scripts.js') }}"></script>
@endpush